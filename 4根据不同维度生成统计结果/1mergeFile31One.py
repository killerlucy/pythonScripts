...
# 设置基础目录和输出文件名
base_directory = r'D:\智网创新\2月报\月报ppt\12月\12月派单分析数据\派单量大稽核统计\31省稽核数据\联通EUTRANCELL所属行政区域完整性稽核\sftp\ads_zhw_wlzt_audit_result_detail_d_ss'
filter_filename = os.path.join(r'D:\智网创新\2月报\月报ppt\12月\12月派单分析数据\派单量大稽核统计\派单量大稽核统计结果', f'联通EUTRANCELL所属行政区域完整性稽核_统计{time_str}.xlsx')
